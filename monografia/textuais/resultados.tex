...
As comunidades detectadas em natação apresentam entropia temporal média de 1.60 e geográfica de 2.59, indicando diversidade moderada. A análise de PageRank revelou hierarquias pronunciadas: Michael Phelps apresenta PageRank de 0.027, valor desproporcionalmente alto que reflete não apenas número de vitórias mas qualidade dos competidores enfrentados. USA domina 8 das 26 comunidades, evidenciando hegemonia estrutural persistente ao longo da história olímpica. A análise de betweenness centrality identificou que 10.2\% dos atletas atuam como pontes conectando comunidades, proporção superior aos esportes coletivos (5.3-7.1\%), refletindo estruturas comunitárias mais definidas.
...
A aplicação de PageRank às 16 redes competitivas revelou hierarquias de importância distintas das classificações tradicionais baseadas em contagem de medalhas. Michael Phelps (Swimming) emerge como o atleta de maior PageRank consolidado (0.027), valor substancialmente superior ao segundo colocado, refletindo não apenas seu sucesso individual mas também a qualidade dos competidores que enfrentou ao longo de múltiplas edições olímpicas.

A análise do ranking global revela predominância de atletas femininas nas primeiras posições: 14 das 20 posições de maior PageRank são ocupadas por mulheres, com destaque para futebolistas americanas (Christie Pearce-Rampone: 0.0156, Shannon Boxx: 0.0151) e jogadoras de basquete (Sue Bird, Tamika Catchings, Teresa Edwards, Lisa Leslie, Diana Taurasi, todas com 0.0136). Esta predominância reflete efeito estrutural de esportes coletivos: Basketball e Football femininos, historicamente com menor número de equipes competindo, resultam em PageRank médio mais elevado por atleta devido à formulação recursiva da métrica.

Entre os novos esportes analisados, destaca-se a distribuição de PageRank em Athletics: Usain Bolt (Jamaica) apresenta PageRank de 0.0098, posicionando-se entre os 10 maiores valores observados apesar da fragmentação acentuada da rede. Em Judo, Teddy Riner (França) com 0.0082 exemplifica dominância sustentada em categoria específica (+100kg). Em Boxing, o PageRank máximo é inferior (0.0045), refletindo maior rotatividade competitiva e menor longevidade olímpica característica da modalidade.
...
\begin{figure}[htbp]
  ...
  \caption{Função de distribuição acumulada (CDF) do PageRank por esporte. O gráfico em escala log-log revela diferenças na concentração de centralidade entre as seis modalidades analisadas. Swimming e Athletics apresentam distribuições mais heterogêneas, com atletas outliers como Michael Phelps e Usain Bolt. Football e Basketball mostram distribuições mais homogêneas, indicando menor concentração de centralidade em poucos atletas.}
...
A Tabela~\ref{tab:top20_pagerank} apresenta os 20 atletas com maior PageRank consolidado considerando todas as modalidades. Michael Phelps (Natação) ocupa a primeira posição com valor substancialmente superior aos demais, refletindo não apenas número de medalhas mas qualidade estrutural dos competidores enfrentados. A predominância de atletas de esportes coletivos nas posições subsequentes evidencia efeito estrutural: redes coletivas densamente conectadas produzem PageRank médio mais elevado por atleta.
