...
A heterogeneidade estrutural entre modalidades valida a estratégia de seleção baseada em três tipos de interdependência competitiva: esportes mistos combinam eventos individuais e por equipes, esportes coletivos apresentam interdependência total entre membros, e esportes individuais caracterizam-se por confrontos diretos sem componente coletivo. A aplicação do algoritmo de Louvain resultou na identificação de 166 comunidades distintas, distribuídas entre Athletics (73 comunidades), Swimming (26), Judo (28), Boxing (28), Basketball (6) e Football (5).
...
A aplicação de PageRank às 16 redes competitivas revelou hierarquias de importância distintas das classificações tradicionais baseadas em contagem de medalhas. O achado mais surpreendente emerge da análise do ranking global: 16 das 20 posições de maior PageRank são ocupadas por atletas de Boxing feminino, modalidade com a menor amostra do estudo (41 atletas, 8 comunidades). Claressa Shields (USA) lidera o ranking global com PageRank de 0.0822, valor 3.2× superior ao de Michael Phelps (Swimming, 11º colocado, 0.0255), apesar deste possuir 28 medalhas olímpicas contra 2 de Shields.

Este fenômeno estrutural resulta da combinação de três fatores: (i) inclusão tardia de Boxing feminino nas Olimpíadas (2012), criando rede temporalmente compacta sem diluição histórica; (ii) alta modularidade da rede (0.82), que concentra PageRank em campeãs de categorias de peso específicas; (iii) tamanho reduzido da rede, onde cada vitória representa fração maior do PageRank total disponível. A Tabela~\ref{tab:network_metrics} confirma que Boxing F apresenta o maior PageRank médio entre todas as modalidades (0.0244), valor 16× superior ao de Football M (0.0008), evidenciando inversão completa entre tamanho amostral e importância estrutural individual.

A análise do ranking global revela predominância massiva de atletas femininas: 19 das 20 posições são ocupadas por mulheres, sendo 16 de Boxing F, 3 de Swimming F (Ledecky, Titmus, posições 12-13) e 1 de Judo F (Ryoko Tamura-Tani, 10ª posição). Esta predominância reflete limitação metodológica reconhecida: PageRank em redes pequenas produz valores inflados devido à concentração de importância em poucos nós, enquanto redes massivas como Football M diluem PageRank mesmo entre campeões históricos.

Entre as redes de maior escala, destaca-se a distribuição de PageRank em Swimming: Michael Phelps (11º global, 1º em Swimming M individual) com 0.0255 exemplifica que, mesmo em redes grandes (511 atletas), dominância sustentada produz PageRank elevado. Em Athletics, Usain Bolt (Jamaica) apresenta PageRank de 0.0098, valor notável dada a fragmentação extrema da rede (1.488 atletas, 38 comunidades). Em Judo, Teddy Riner (França) com 0.0082 exemplifica dominância em categoria específica (+100kg), enquanto Boxing M apresenta PageRank máximo inferior ao feminino (0.0045 vs 0.0822), refletindo maior rotatividade competitiva e fragmentação temporal.

A distribuição de PageRank entre modalidades revela padrões sistemáticos: esportes mistos apresentam maior variabilidade (desvio padrão Swimming: 0.0024, Athletics: 0.0021), esportes coletivos distribuições mais homogêneas (Basketball: 0.0018, Football: 0.0012), e esportes individuais valores intermediários (Judo: 0.0019, Boxing: 0.0016). A razão entre PageRank máximo e médio oferece métrica de concentração: Athletics apresenta razão de 18.2, Boxing 12.4, Judo 15.7, valores intermediários entre Swimming (14.9) e Football (19.4).
...
A Tabela~\ref{tab:top20_pagerank} apresenta os 20 atletas com maior PageRank consolidado considerando todas as modalidades. Claressa Shields (Boxing F, USA) ocupa a primeira posição com PageRank de 0.0822, seguida por Nicola Adams (Boxing F, GBR) com 0.0705. As cinco primeiras posições são exclusivamente ocupadas por boxeadoras, refletindo o efeito de concentração estrutural em redes pequenas discutido anteriormente. A predominância massiva de atletas femininas (19 das 20 posições) evidencia limitação metodológica: PageRank em redes de tamanho reduzido produz valores inflados devido à menor diluição de importância entre nós.
