...
\textit{Escopo de modalidades:} Foco em três esportes (5\% das modalidades olímpicas), impossibilitando generalização para todas as 84 modalidades. Esportes com características distintas (combate individual, eventos cronometrados, modalidades artísticas) podem produzir propriedades estruturais não capturadas.
