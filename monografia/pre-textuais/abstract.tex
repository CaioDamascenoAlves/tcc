\begin{resumo}[Abstract]
 \begin{otherlanguage*}{english}
   This monograph presents the application of complex network analysis to historical Olympic data (1896-2016), modeling sports competitions through directed and weighted graphs that reveal latent competitive structures. The work analyzes 9,378 medalist athletes across six sports (Swimming, Basketball, Football, Athletics, Judo, Boxing) spanning 120 years of Olympic history.
