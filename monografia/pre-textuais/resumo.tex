...
\begin{resumo}
    Esta monografia apresenta aplicação de análise de redes complexas a dados históricos olímpicos (1896-2016), modelando competições esportivas através de grafos direcionados e ponderados que revelam estruturas competitivas latentes. O trabalho analisa 9.378 atletas medalhistas em seis modalidades (Swimming, Basketball, Football, Athletics, Judo, Boxing) ao longo de 120 anos de história olímpica.
