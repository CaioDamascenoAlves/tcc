\begin{frame}{Trabalho Relacionado}
    \begin{columns}[T]
        ...
        \begin{block}{Contexto}
            \begin{itemize}
                \item \cite{faria2021podium} estudam a \textit{influência} de pilotos de Fórmula 1.
...
\begin{frame}{Trabalho Relacionado}
    \begin{columns}[T]
        ...
        \begin{block}{Contexto}
            \begin{itemize}
                \item \cite{pereira2019complex} analisam o \textit{desempenho} de nadadores em Jogos Olímpicos.
