...
\begin{frame}{Atletas-Ponte: Betweenness Centrality}
    ...
    \begin{center}
        \includegraphics[width=0.70\textwidth]{../monografia/figuras/fig_betweenness_violin.png}
    \end{center}
    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.48\textwidth}
            \begin{block}{Distribuição}
                \footnotesize
                \textbf{Swimming}: 10.2\% \quad \textbf{Basketball}: 7.1\% \quad \textbf{Football}: 5.3\%
            \end{block}
        \end{column}
    \end{columns}
